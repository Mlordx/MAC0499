...
\author{Aluno: $\text{Mateus Barros Rodrigues}^{[1]}$\\Orientador: $\text{Prof. Dr. Carlos Eduardo Ferreira}^{[2]}$}
\affil{
  Instituto de Matemática e Estatística - Universidade de São Paulo\\%
  \texttt{[1] mateus.barros.rodrigues@usp.br\\}%
  \texttt{[2] cef@ime.usp.br}%
...
{\colorlet{blocktitlebgcolor}{my-blue}\block{Introdução}{ Este trabalho de conclusão de curso fundamentou-se na compreensão e
    ...
    adaptação do visualizador de algoritmos geométricos feito por Alexis Sakurai Landgraf~\cite{site2} para exposição dos resultados obtidos.
}}

%------------------------------------------------------------------------------%

{\colorlet{blocktitlebgcolor}{my-black}\block{Consultas em janelas}{ Neste trabalho foi abordado o problema de \emph{consultas de
...
{\colorlet{blocktitlebgcolor}{my-green}\block{Mais exemplos}{
    \begin{tikzfigure}
      \centering
...
{\colorlet{blocktitlebgcolor}{my-darkblue}\block{Referências}{
