...
{\colorlet{blocktitlebgcolor}{my-blue}\block{Introdução}{ Este trabalho de conclusão de curso fundamentou-se na compreensão e
    ...
    retangulares no espaço, um subproblema de geometria computacional conhecido por: buscas em regiões ortogonais. Este algoritmo
...
{\colorlet{blocktitlebgcolor}{my-green}\block{Consultas em janelas}{ Neste trabalho foi abordado o problema de \emph{consultas de
    ...
    Para resolvermos esse problema, começamos criando 4 estruturas baseadas em $S$: duas \textbf{árvores limite com camadas}, uma sobre o
    conjunto de pontos esquerdos de $S$ e outra sobre o conjunto de pontos direitos de $S$, e duas \textbf{árvores de segmentos 2D}, uma
    horizontal e a outra vertical.\\
...
{\colorlet{blocktitlebgcolor}{my-green}\block{Simulação}{ Para exemplificarmos o tipo de problema resolvido, segue uma série
    ...
    \begin{tikzfigure}
      ...
      \captionof{figure}{Conjunto de segmentos e janela a ser utilizada na consulta.}
      \label{diag:0}
    \end{tikzfigure}
    ...
    \begin{tikzfigure}
      ...
      %\captionsetup{type=diagram}
      \captionof{figure}{Destacamos em azul os segmentos cuja ponta esquerda está na janela.}
      \label{diag:1}
    \end{tikzfigure}
    ...
    \begin{tikzfigure}
      ...
      %\captionsetup{type=diagram}
      \captionof{figure}{Destacamos em amarelo os segmentos cuja ponta direita está na janela.}
      \label{diag:2}
    \end{tikzfigure}
