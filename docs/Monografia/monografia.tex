...
\mathbb{R}^2$) é o conjunto~$\{p \in \mathbb{R}^2 \colon p = (1-t)*u + t*v~\text{para algum}~t \in [0,1]\} \subseteq \mathbb{R}^2$. Seremos um pouco
...
\item[3.] Percorremos a subárvore direita de $v_{div}$ de forma simétrica ao item 3.
\end{itemize}
