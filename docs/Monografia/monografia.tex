...
A estrutura de dados que utilizaremos para essa consulta é chamada de \textbf{árvore de busca em prioridade}. Os nós da estrutura terão 4 campos: Um
ponteiro para o ponto associado ao nó, um ponteiro para o filho esquerdo, um ponteiro para o filho direito e um ponteiro para um ponto denominado
$p_{min}$, através desse ponteiro manteremos a propriedade de \emph{minheap}. Ela será balanceada por construção.
