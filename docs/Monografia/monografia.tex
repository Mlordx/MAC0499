...
pela existência de um visualizador de algoritmos geométricos criado por Alexis Sakurai Landgraf. Visto isso, não visamos, nesse
trabalho, obter uma implementação eficiente e otimizada destes algoritmos. Mas, sempre fazendo a melhor implementação conhecida
para os algoritmos, visamos obter uma implementação fácil de acompanhar para um leitor com experiência em algoritmos de geometria
computacional. Toda a implementação está disponível no \href{http://github.com/mlordx/MAC0499/}{gitHub} juntamente com a adaptação
do visualizador geométrico que foi feita.
