...
\item[-] As modificações presentes nas linhas \ref{alg4:4} e \ref{alg4:5} foram adicionadas apenas para resolverem os casos
  degenerados apresentados no capítulo $x$.
\end{itemize}
...
\begin{itemize}
\item[0.] Construímos a ABBB sobre o conjunto $P$.
...
\begin{itemize}
\item[0.] Construímos a árvore limite sobre o conjunto $P$.
...
\begin{itemize}
\item[0.] Construímos a árvore limite com camadas sobre o conjunto $P$.
...
vetor ordenado. A relação de ordem que usaremos é: Sejam $u$ e $v$ segmentos, diremos que $u < v$ caso $u$ esteja à direita de
$v$, ou caso $u$ pseudo-intercepte $v$ e $v$ esteja à esquerda de $u$.
