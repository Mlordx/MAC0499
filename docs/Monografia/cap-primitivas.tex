...
$ s = \overline{(x_1,y_1)(x_2,y_2)}$ onde $u = (x_1,y_1)$ e $v = (x_2,y_2)$ são pontos chamados de pontos extremos de $s$. 
\subsection{Comparações}
\par
Uma outra noção que será usada copiosamente ao longo desta monografia é a noção de desigualdade em relação a uma dada
...
Sejam $p = (x_1,y_1)$, $s = \overline{(x_2,y_2),(x_3,y_3)}$ e 
\begin{math}
d = \det{
\begin{pmatrix}
  x_1 && y_1 && 1 \\ 
